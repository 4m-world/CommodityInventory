...
namespace MyInventoryApp.Droid.Renderers
{
    public class BadgeView : TextView
    {
        ...
        const int DefaultHmarginDip = -10;
        const int DefaultVmarginDip = 2;
        const int DefaultLrPaddingDip = 4;
        const int DefaultCornerRadiusDip = 7;

        static Animation _fadeInAnimation;
        static Animation _fadeOutAnimation;

        Context _context;
        readonly Color _defaultBadgeColor = Color.ParseColor("#CCFF0000");
        ShapeDrawable _backgroundShape;
        ...
        void Init(Context context, View target)
        {
            _context = context;
            Target = target;
        ...
        void Show(bool animate, Animation anim)
        {
            ApplyLayoutParams();
        ...
        void Hide(bool animate, Animation anim)
        {
            Visibility = ViewStates.Gone;
            if (animate)
            {
